...
Thank you for your interest in contributing to [mender](https://github.com/dileepadev/mender)! We welcome contributions, including bug fixes, feature enhancements, documentation improvements, and other general improvements.
...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/mender/fork).

2. **Clone your fork**  
   Clone your forked repository to your local machine using the following command:

   ```bash
   git clone https://github.com/<your-username>/mender.git
   ```
...
- Refer to the following templates and guidelines before submitting your changes:
  - [mender/](./) - Root directory of the repository
